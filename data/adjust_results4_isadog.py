...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Determine whether the pet image label and classifier label are dogs
    for key in results_dic:
        ...
        # Classifier labels can contain multiple names separated by commas
        classifier_is_dog = 0

        for dog_name in dognames_dic:
            if dog_name in classifier_label.split(","):
                classifier_is_dog = 1
                break

        # Add dog classifications to results dictionary
